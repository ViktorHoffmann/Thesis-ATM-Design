...
ax1.plot(x_values, maxQHeatflux, color='dimgrey', linestyle='-', label=r'$\dot{q}_{\mathrm{maxQ}}$')
ax1.plot(x_values, maxQp10Heatflux, color='darkgrey', linestyle='-', label=r'$\dot{q}_{\mathrm{maxQ+10}}$')
ax1.plot(x_values, maxQp20Heatflux, color='lightgrey', linestyle='-', label=r'$\dot{q}_{\mathrm{maxQ+20}}$')
